...
\end{Verbatim}
See the developer manual for how to install it on your system.
...
authentication. Log in on \url{http://trac.sagemath.org} and go to
preferences $\to$ SSH keys. See the developer manual for more
details. 
...
\end{Verbatim}
Much more information can be found in the Sage developer guide.
